    ...
    return (
      ...
      <div className="buju-denglu">
            ...
            <form action="#" className="form-denglu" id="form-denglu">
                ...
                <input id="input-username" type="text" className={classNames("input",{'is-invalid':(emailorid? false:true)})}  value={emailorid} onChange={e=>{setEmailorid(e.target.value)}}></input>
                <div className="gekai"></div>
                <p className="p1">您的密码：</p>
                <input id="input-password"  type="password"  className="input"  value={password} onChange={e=>{setPassword(e.target.value)}}></input>
